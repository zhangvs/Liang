            ...
            if (!string.IsNullOrEmpty(organizeId))
            {
                ...
                if (!string.IsNullOrEmpty(organize.OrganizeId))
                {
                    ...
                    foreach (var item in entityList)
                    {
                        ...
                        styleStr +=
                        $" <li> " +
                        $"    <a href='https://shop.jnlxsm.net/webapp/jinan2/mobileinfo/{item.TelphoneID}?host={host}'>" +//跳转到135服务器详情页面
            ...
            try
            {
                ...
                if (payType == "支付宝")
                {
                    try
                    {
                        ...
                        model.QuitUrl = "https://shop.jnlxsm.net:8064/webapp/jinan2/index";// 支付中途退出返回商户网站地址
