            ...
            if (!string.IsNullOrEmpty(organizeId))
            {
                ...
                if (!string.IsNullOrEmpty(organize.OrganizeId))
                {
                    ...
                    foreach (var item in entityList)
                    {
                        ...
                        styleStr +=
                        $" <li> " +
                        $"    <a href='https://shop.jnlxsm.net/webapp/jinan/mobileinfo/{item.TelphoneID}?host={host}'>" +//跳转到135服务器详情页面
            ...
            try
            {
                ...
                if (payType == "支付宝")
                {
                    try
                    {
                        ...
                        model.QuitUrl = "https://shop.jnlxsm.net:8063/webapp/jinan/index";// 支付中途退出返回商户网站地址
